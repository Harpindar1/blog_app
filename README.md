...
## Frontend Design
The frontend of the application is designed using Bootstrap 5.3 to ensure a responsive and aesthetically pleasing user interface. Forms, tables, and buttons are styled using Bootstrap classes.

## Installation

1. Clone the repository:
   ```bash
   git clone [https://github.com/your-username/laravel-blog-app.git](https://github.com/Harpindar1/blog_app.git)
   cd blog_app
